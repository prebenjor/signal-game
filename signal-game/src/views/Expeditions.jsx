...
export default function ExpeditionsView(props) {
  ...
  return (
    <section className="panel space-y-4 expedition-command">
      <div className="relative overflow-hidden rounded-2xl border border-cyan-400/20 bg-slate-950/80 p-4 expedition-banner">
        ...
        <div className="relative z-10 flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <div className="text-2xl font-semibold">Survey - Colonize - Operate</div>
