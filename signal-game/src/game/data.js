...
export const HUB_BUILDINGS = [
  ...
  { id: "reactor", name: "Micro Reactor", desc: "+3 power/tick, -1 fuel", cost: { metal: 70, fuel: 5 }, prod: { power: 3 }, cons: { fuel: 1 }, tier: 0, category: "power", costExp: 1.14, unlock: { requires: [{ id: "salvage_dock", level: 1 }] } },
