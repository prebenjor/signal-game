...
export const BIOME_BUILDINGS = {
  asteroid: [
    ...
    { id: "core_rig", name: "Core Rig", desc: "Rig branch: +4 rare/tick, +4 metal/tick", cost: { metal: 260, fuel: 40 }, prod: { rare: 4, metal: 4 }, cons: { power: 2 }, requires: [{ id: "ore_rig", level: 3 }], group: "rig_branch" },
    ...
    { id: "core_tap", name: "Core Tap", desc: "+6 metal/tick, +2 rare/tick", cost: { metal: 260, fuel: 50 }, prod: { metal: 6, rare: 2 }, cons: { power: 2 }, requires: [{ id: "ore_rig", level: 2 }] },
  ...
  ice: [
    ...
    { id: "protein_farm", name: "Protein Farm", desc: "Algae branch: +6 food/tick, +3% morale", cost: { metal: 180, organics: 70 }, prod: { food: 6, morale: 0.03 }, cons: { power: 1 }, requires: [{ id: "algae_farm", level: 3 }], group: "algae_branch" },
    { id: "bio_reactor", name: "Bio-Reactor", desc: "Algae branch: food -> power/fuel", cost: { metal: 200, organics: 80, fuel: 20 }, prod: { power: 3, fuel: 2 }, cons: { food: 1 }, requires: [{ id: "algae_farm", level: 3 }], group: "algae_branch" },
    { id: "logistics_depot", name: "Logistics Depot", desc: "+5% cargo, -5% travel time", cost: { metal: 180, fuel: 20 }, prod: {}, cons: { power: 1 }, cargoMult: 1.05, travelMult: 0.95 },
    { id: "cryo_distillery", name: "Cryo Distillery", desc: "Converts organics to fuel (+4 fuel/tick, -1 organics/tick)", cost: { metal: 200, organics: 80 }, prod: { fuel: 4 }, cons: { organics: 1, power: 1 }, requires: [{ id: "thermal_pump", level: 2 }] },
    { id: "glacier_observatory", name: "Glacier Observatory", desc: "+4 research/tick", cost: { metal: 260, fuel: 40 }, prod: { research: 4 }, cons: { power: 2 }, requires: [{ id: "cryo_distillery", level: 1 }] },
  ],
  warm: [
    { id: "maintenance_bay", name: "Maintenance Bay", desc: "+2 maintenance cap", cost: { metal: 110, fuel: 10 }, prod: {}, cons: { power: 1 }, maintenanceCap: 2 },
    ...
    { id: "logistics_depot", name: "Logistics Depot", desc: "+5% cargo, -5% travel time", cost: { metal: 180, fuel: 20 }, prod: {}, cons: { power: 1 }, cargoMult: 1.05, travelMult: 0.95 },
    { id: "plasma_furnace", name: "Plasma Furnace", desc: "+8 power/tick, +5 metal/tick", cost: { metal: 240, fuel: 60 }, prod: { power: 8, metal: 5 }, cons: { fuel: 2 } },
  ...
  unknown: [
    ...
    { id: "ward_matrix", name: "Ward Matrix", desc: "Lab branch: -40% hazard, +3 rare/tick", cost: { metal: 260, rare: 12 }, prod: { rare: 3 }, cons: { power: 2 }, requires: [{ id: "anomaly_lab", level: 2 }], hazardMult: 0.6, group: "lab_branch" },
    { id: "logistics_depot", name: "Logistics Depot", desc: "+5% cargo, -5% travel time", cost: { metal: 180, fuel: 20 }, prod: {}, cons: { power: 1 }, cargoMult: 1.05, travelMult: 0.95 },
    { id: "phase_relay", name: "Phase Relay", desc: "+5 signal/tick, -travel time for missions", cost: { metal: 240, rare: 10, fuel: 40 }, prod: { signal: 5 }, cons: { power: 2 }, travelMult: 0.85 },
    { id: "anomaly_vault", name: "Anomaly Vault", desc: "+6 rare/tick, +6 research/tick", cost: { metal: 320, rare: 16 }, prod: { rare: 6, research: 6 }, cons: { power: 2 }, requires: [{ id: "anomaly_lab", level: 2 }] },
  ],
};
